...
communities\\
	...
	- \cusemph{Co-authored two scientific publications on the topic of Crowdsourcing and Collective Intelligence}\\\\
...
\begin{project}
  ...
  \description{
	...
	\footnotesize{\textcolor{mygray}{\textbf{Research methods applied:} observational studies - interviews}}
  }
\end{project}
\begin{project}
  \title{BPM4People}
...
\begin{project}
  ...
  \description{
	...
	\footnotesize{\textcolor{mygray}{\textbf{Research methods applied:} usability tests - surveys}}
  }
\end{project}