...
P.h.D. student, informatics engineer and open-source supporter with experience as a software engineer, researcher and teaching assistant.
...
\item[2001 - 2006] {\bf Bachelor of Science (B.Sc.), Informatics Engineering} - Catholic University ''Nuestra Señora de la Asunción'', Asunción, Paraguay. 
...
\item[March 2014 - Present] \emph{Researcher} - The Finnish Experiment Project. A research project of the Committee for the Future in the Parliament of Finland.

Study on how collective intelligence, whether gathered by crowdsourcing and/or principles of open innovation, impacts processes of policy making. 
...
Modeled, designed, and implemented a civic-participation tool for supporting the execution of public consultants, idea campaigns, and opinion polls directly in hashtag-supported social networking sites, such as Twitter, Facebook, and Google Plus. 
...
\item[October 2013 - December 2013] \emph{Visiting Researcher} - Hewlett-Packard Laboratories, Information Analysis Division, Palo Alto, California, USA.
...
\item[November 2011 - August 2013] \emph{Researcher} - BPM4People Project (\url{http://www.bpm4people.org}): EU FP7 Research Project.
...
Developed and maintenance of Sugar OS apps (Labyrinth, Poll, TamTam). 
...
Mounted and maintained of Unix servers. Set up and configured OLPC XO laptops. Developed and customized educational applications for Sugar OS.
...
Developed, tested and maintained a web-based (ruby on rails) business management system (billing, stocking, accounting, freighting, human resources)
...
\item [February 2015 - Present] \emph{Teaching Assistant} - Department of Information Engineering and Computer Science, University of Trento, Italy.

Teaching Assistant in the Introduction to Web Programming class part of the Computer Science program.

\item [November 2014 - March 2015] \emph{Master Thesis Co-Supervisor} - Department of Information Engineering and Computer Science, University of Trento, Italy.

Shahadat Chowdhury's Master Thesis Co-Supervisor. Title: Analyzing and Visualizing citizen opinions collected from social networks.

\item [May 2010 - July 2010] \emph{Lecturer} - Polytechnic School, National University of Asuncion, Paraguay.

Tutor of a course about development for Sugar OS.

\item [February 2007 - July 2007] \emph{Teaching Assistant} - Science and Technology School, Catholic University ``Nuestra Señora de la Asunción''

Teaching Assistant in Programming Languages 1 part of the System Analysis program.

\item [August 2006 - December 2006] \emph{Teaching Assistant} - Science and Technology School, Catholic University ``Nuestra Señora de la Asunción''

Teaching Assistant in Programming Languages 1 part of the Information Technology Engineering program.
...
\bibitem{sal15cscw}
T. Aitamurto, H. Landemore, J. Saldivar. \emph{Unmasking the Crowd: Participants? Motivation Factors and Profile in Crowdsourced Law Reform}. Information, Communication and Society Journal. (under review)

\bibitem{sal15cscw}
T. Aitamurto, J. Saldivar. \emph{Motivation Factors in Crowdsourced Policymaking: Problem-solving, Learning, and Interaction with Peers and Experts}. Computer-Supported Cooperative Work and Social Computing, 2016. (under review)
...
\bibitem{sal14jou}
J. Saldivar, C. Vairetti, C. Rodriguez, F. Daniel, F. Casati, R. Alarcón. \emph{Spreadsheet-based Testing of Business Process}. Elsevier Information Systems Journal. (under revision)
