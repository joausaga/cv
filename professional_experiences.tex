...
\begin{professionalexp}
  ...
  \description{
  	- Coordinated the implementation of an analytics tool that uses machine learning (ML) and natural language processing (NLP) techniques (\textbf{classification}, \textbf{clustering}, \textbf{concept extraction}, \textbf{sentiment analysis}) to automate the analysis of crowdsourced textual data\\
  	...
  	- \cusemph{Co-authored six papers in international conferences on the topics of Crowdsourcing, Collective Intelligence, and Applied Machine Learning}
  }
\end{professionalexp}
...
\begin{professionalexp}
  ...
  \description{
	...
	- \cusemph{Co-authored five scientific articles in IEEE and ACM journals and international conferences on the topics of Crowdsourcing for Democracy and Collective Intelligence}
  }
\end{professionalexp}
\begin{professionalexp}
  ...
  \description{
	...
	- \cusemph{Co-authored a scientific paper on the topic of Crowdsourcing for Democracy}
  }
\end{professionalexp}
\begin{professionalexp}
