...
\ecvitem[10pt]{Organisational / managerial skills}{Excellent teamwork skills thanks to my experience as:
\begin{itemize}
\item Secretary of the board of my high-school student association.
\item Coordinator of social campaigns to assist families of urban areas in financial hardship.
\item Electoral delegate in local elections and presidential votes. 
...
\ecvitem[10pt]{Job-related skills}{Enough experience as teaching assistant, public speaker, and course facilitator thanks to my previous work at the Catholic University ``Nuestra Señora de la Asunción'', Paraguay, at the NGO Paraguay Educa, at the Polytechnic School, National University of Asuncion, Paraguay, and recently at Department of Information Engineering and Computer Science, University of Trento, Italy.}

\ecvitem[10pt]{Computer skills}{Proficient in the programming languages: Java, Python, Javascript, R, PHP, SQL, Ruby, C, C++, Bash, $C\sharp$, Visual Basic; in the development frameworks: Ruby on Rails, Yii, ExtJS, Qooxdoo, Drupal, Play, JQuery, Bootstrap, Django; and in the operating systems: Linux, OS X.}
