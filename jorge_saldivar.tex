...
\begin{center}
\begin{large}
\textbf{Technology Portfolio Management}
\end{large}
\end{center}

Pragmatic, tenacious and altruistic \textbf{Information Technology Engineering} who has spent most of his professional career applying his strong engineering background, and abilities in building technological solutions for addressing highly challenging societal issues, such as promoting civic participation in a socio-cultural context conditioned by a long, oppressive and violent dictatorship, or improving the elementary education of disadvantaged rural communities. Idealist, clever and audacious professional with a long career as civic activist and years of passionate work dedicated to create tailored innovations that make a difference in people's life.\\  
\par \textbf{Core competences include:}
\begin{enumerate*}[label=\itshape\alph*\upshape)]
\item research work in the area of social innovation, democratic innovation, collective intelligence, crowdsourcing, and social business processes;
\item developing skills in several programming languages and web development frameworks, including Python (Django), Java (Play), Ruby (Ruby on Rails), PHP (Yii), Javascript, C;
\item leadership and interpersonal relationship skills and teamwork;
\item teaching experience as professor assistant.
\end{enumerate*}

\rule{\textwidth}{1pt}

\section{Civic Experience}
...
[UNDER-REVIEW] T. Aitamurto, J. Saldivar, J. Salminen. \emph{Self-selection in Crowdsourcing Democracy: A Bug or A Future?}. Crowdwork Workshop, ACM Conference on Supporting Groupwork, 2014, Sanibel Island, Florida, USA.

\bibitem{sal14s}
[UNDER-REVIEW] J. Saldivar, C. Vairetti, C. Rodriguez, F. Daniel, F. Casati, R. Alarcón. \emph{Spreadsheet-based testing of business process}. Elsevier Information Systems.
